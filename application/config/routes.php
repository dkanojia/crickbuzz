...
$route['tournament_match_list_api/(:num)'] = 'tournament_match_list_api/$1';
$route['match_team_list_api/(:num)'] = 'match_team_list_api/$1';
$route['team_player_list_api/(:num)'] = 'team_player_list_api/$1';
$route['players_detail_page_api/(:num)'] = 'players_detail_page_api/$1';
