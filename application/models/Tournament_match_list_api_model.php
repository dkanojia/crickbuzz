...
class Tournament_match_list_api_model extends CI_Model {
	...
	function all_match($tr_id) {
		...
		foreach($data as $key => $value) {
			...
			// $img_src = "http://".getenv('HTTP_HOST')."/cric/public/team_s_banner/".$tourna[0]['tour_name']."/".$tourna[0]['tour_banner'];
			...
			if(($status == 1) || ($status == 2) ){		
				$ongoing = $ongoing . '{ "start_date":"'.$start_date.'"  , "end_date":"'.$end_date.'"  , "start_time" : "'.$start_time.'" , "end_time" : "'.$end_time.'" ,"status":"ongoing" ,  "ground_name":"'.$ground_name.'" , "overs":"'.$overs.'" , "place":"'.$place.'" , "tournament_name":"'.$tourna[0]['tour_name'].'" ,  "team1_id":"'.$team1_id.'", "team2_id":"'.$team2_id.'" , "team1_name":"'.$team1[0]['team_name'].'" ,"team2_name":"'.$team2[0]['team_name'].'" , "team1_logo":"'.$team1_logo_img_src.'" ,"team2_logo":"'.$team2_logo_img_src.'" , "description":"'.$value['description'].'", "tour_banner":"'."http://".getenv('HTTP_HOST')."/cric/public/team_s_banner/".$tourna[0]['tour_name']."/".$tourna[0]['tour_banner'].'" , "title":"'.$value['title'].'"},';				
